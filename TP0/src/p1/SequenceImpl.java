	...
	public boolean subSeq(Object[] t1, Object[] t2) {	
		...
		for(int i = 0; i < t1.length; i++) {
			...
			if(presentSuite(t1[i], t2, pos)) {
				...
				if(!jokerUsed && resteSuitePresent(t1, t2, i+1, pos)) {//cas où on zappe potentiellement la suite alors qu'elle est inclue avant 'pos' dans t2
					return true;
				}
...
//permet de savoir si les éléments de 't1' à partir de 'posts1' sont inclus dans 't2' à partir de 'post2'
	...
	private int positionSuite(Object o, Object[] t, int pos) {
		...
		return 300; //on n'est pas censé arriver ici		
	}
