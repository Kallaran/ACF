...
public class MainTest {
	...
	public void test15() { 
		Integer[] t1 = new Integer[] { 1, 2, 3};
		Integer[] t2 = new Integer[] { 0, 2, 3};
		
		assertTrue(s.subSeq(t1,t2));
	}
	
	@Test
	public void test16() { // cas où un élément de t1 est présent mais provoque potentiellement le "saut" des éléments restants de t1
		Integer[] t1 = new Integer[] { 1, 2, 3, 4};
		Integer[] t2 = new Integer[] { 0, 1, 3, 4, 2};
